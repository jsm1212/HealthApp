...
//    fun getMyRoutine_M(@Body nick:String): Call<String>
    ...
    // 내 게시글 목록
    @POST("/getMyBbs_M")
    fun getMyBbs_M(@Body nick:String): Call<List<BbsDto>>

    // 내 댓글 목록
    @POST("/getMyReply_M")
    fun getMyReply_M(@Body nick:String): Call<List<BbsReplyDto>>

    // 좋아요 누른 글 목록
    @POST("/getMyLike_M")
    fun getMyLike_M(@Body nick:String): Call<List<BbsDto>>
}
class MypageDao {
    companion object{
    ...
    // 운동 루틴
//    fun getMyRoutine_M(nick:String) : ArrayList<BbsReplyDto>?{
//        val retrofit = RetrofitClient.getInstance()
//        val service = retrofit?.create(MypageService::class.java)
//        val call = service?.getMyBbs_M(nick)
...
//    }
    ...
    // 내 게시글 목록
    fun getMyBbs_M(nick:String) : ArrayList<BbsDto>?{
        println("확인!!!!!!!!!! 게시글 목록!!!!!!!!!!")
    ...
    // 내 댓글 목록
    fun getMyReply_M(nick:String) : ArrayList<BbsReplyDto>?{
        println("확인!!!!!!!!!! 댓글 목록!!!!!!!!!!")

        val retrofit = RetrofitClient.getInstance()
        val service = retrofit?.create(MypageService::class.java)
        val call = service?.getMyReply_M(nick)
        val response = call?.execute()
    ...
    // 좋아요 누른 글 목록
    fun getMyLike_M(nick:String) : ArrayList<BbsDto>?{
        println("확인!!!!!!!!!! 좋아요 목록!!!!!!!!!!")

        val retrofit = RetrofitClient.getInstance()
        val service = retrofit?.create(MypageService::class.java)
        val call = service?.getMyLike_M(nick)
        val response = call?.execute()
